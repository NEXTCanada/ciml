...
order.  This is actually a bad idea.
...
\begin{mathreview}{Dot Products}
  ...
  $\vec b$ is parallel to $\vec u$ and $\vec a$ is perpendicular.
...
% (like that shown in Figure~\ref{fig:perc:margin})
...
\begin{myproof}{\ref{thm:perc:perc}}
  ...
  $\vw^*$.  Suppose we train a perceptron on this data.  Denote by
